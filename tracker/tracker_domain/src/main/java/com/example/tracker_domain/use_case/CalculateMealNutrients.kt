...
class CalculateMealNutrients(
    ...
    operator fun invoke(
       ...
       val allNutrient = trackedFoods.groupBy {
            it.mealType
        }
            .mapValues {entry ->
                val type = entry.key
        ...
        val totalCarbs = allNutrient.values.sumOf { it.carbs }
        val totalProtein = allNutrient.values.sumOf { it.protein }
        val totalFat = allNutrient.values.sumOf { it.fat }
        val totalCalories = allNutrient.values.sumOf { it.calories }
